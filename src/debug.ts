...
import { CLAUDE_PROJECTS_DIR_NAME, DEBUG_MATCH_THRESHOLD_PERCENT, DEFAULT_CLAUDE_CONFIG_PATH, USAGE_DATA_GLOB_PATTERN } from './_consts.ts';
...
export async function detectMismatches(
	...
	const claudeDir = claudePath ?? path.join(DEFAULT_CLAUDE_CONFIG_PATH, CLAUDE_PROJECTS_DIR_NAME);
